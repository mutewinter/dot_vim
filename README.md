...
| ![Star count](https://flat.badgen.net/github/stars/christoomey/vim-tmux-navigator?label=★&color=black) |[vim-tmux-navigator](https://github.com/christoomey/vim-tmux-navigator) [:page_facing_up:](plug_plugins/vim-tmux-navigator.vim)|Seamless navigation between tmux panes and vim splits |
...
| ![Star count](https://flat.badgen.net/github/stars/RRethy/vim-illuminate?label=★&color=black) |[vim-illuminate](https://github.com/RRethy/vim-illuminate) [:page_facing_up:](plug_plugins/vim-illuminate.vim)|illuminate.vim - Vim plugin for automatically highlighting other uses of the word under the cursor |
...
| ![Star count](https://flat.badgen.net/github/stars/pbogut/fzf-mru.vim?label=★&color=black) |[fzf-mru.vim](https://github.com/pbogut/fzf-mru.vim) [:page_facing_up:](plug_plugins/fzf-mru.vim)|Vim plugin that allows using awesome CtrlP MRU plugin with even more amazing FZF |
